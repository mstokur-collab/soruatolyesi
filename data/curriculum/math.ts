...
const mathLegacyCurriculum: LegacyCurriculum = {
    5: [
      {
        ...
        altKonular: [
          {
            ...
            kazanımlar: [
              { id: 'M.7.1.1.1', text: 'Tam sayılarla toplama ve çıkarma işlemlerini yapar, ilgili problemleri çözer.' },
              { id: 'M.7.1.1.2', text: 'Toplama işleminin özelliklerini akıcı işlem yapmak için birer strateji olarak kullanır.' },
              { id: 'M.7.1.1.3', text: 'Tam sayılarla çarpma ve bölme işlemlerini yapar.' },
              { id: 'M.7.1.1.4', text: 'Tam sayıların kendileri ile tekrarlı çarpımını üslü nicelik olarak ifade eder.' },
              { id: 'M.7.1.1.5', text: 'Tam sayılarla işlemler yapmayı gerektiren problemleri çözer.' },
            ],
          },
          {
            name: 'Rasyonel Sayılar',
            kazanımlar: [
              { id: 'M.7.1.2.1', text: 'Rasyonel sayıları tanır ve sayı doğrusunda gösterir.' },
              { id: 'M.7.1.2.2', text: 'Rasyonel sayıları ondalık gösterimle ifade eder.' },
              { id: 'M.7.1.2.3', text: 'Devirli olan ve olmayan ondalık gösterimleri rasyonel sayı olarak ifade eder.' },
              { id: 'M.7.1.2.4', text: 'Rasyonel sayıları sıralar ve karşılaştırır.' },
            ],
          },
          {
            name: 'Rasyonel Sayılarla İşlemler',
            kazanımlar: [
              { id: 'M.7.1.3.1', text: 'Rasyonel sayılarla toplama ve çıkarma işlemlerini yapar.' },
              { id: 'M.7.1.3.2', text: 'Rasyonel sayılarla çarpma ve bölme işlemlerini yapar.' },
              { id: 'M.7.1.3.3', text: 'Rasyonel sayılarla çok adımlı işlemleri yapar.' },
              { id: 'M.7.1.3.4', text: 'Rasyonel sayıların kare ve küplerini hesaplar.' },
              { id: 'M.7.1.3.5', text: 'Rasyonel sayılarla işlem yapmayı gerektiren problemleri çözer.' },
            ],
          },
          {
            name: 'Oran ve Orantı',
            kazanımlar: [
              { id: 'M.7.1.4.1', text: 'Oranda çokluklardan birinin 1 olması durumunda diğerinin alacağı değeri belirler.' },
              { id: 'M.7.1.4.2', text: 'Birbirine oranı verilen iki çokluktan biri verildiğinde diğerini bulur.' },
              { id: 'M.7.1.4.3', text: 'Gerçek hayat durumlarını inceleyerek iki çokluğun orantılı olup olmadığına karar verir.' },
              { id: 'M.7.1.4.4', text: 'Doğru orantılı iki çokluk arasındaki ilişkiyi ifade eder.' },
              { id: 'M.7.1.4.5', text: 'Doğru orantılı iki çokluğa ait orantı sabitini belirler ve yorumlar.' },
              { id: 'M.7.1.4.6', text: 'Gerçek hayat durumlarını inceleyerek iki çokluğun ters orantılı olup olmadığına karar verir.' },
              { id: 'M.7.1.4.7', text: 'Doğru ve ters orantıyla ilgili problemleri çözer.' },
            ],
          },
          {
            name: 'Yüzdeler',
            kazanımlar: [
              { id: 'M.7.1.5.1', text: 'Bir çokluğun belirtilen bir yüzdesine karşılık gelen miktarını ve belirli bir yüzdesi verilen çokluğun tamamını bulur.' },
              { id: 'M.7.1.5.2', text: 'Bir çokluğu diğer bir çokluğun yüzdesi olarak hesaplar.' },
              { id: 'M.7.1.5.3', text: 'Bir çokluğu belirli bir yüzde ile arttırmaya veya azaltmaya yönelik hesaplamalar yapar.' },
              { id: 'M.7.1.5.4', text: 'Yüzde ile ilgili problemleri çözer.' },
            ],
          },
        ],
      },
        ...
        altKonular: [
          {
            ...
            kazanımlar: [
              { id: 'M.7.2.1.1', text: 'Cebirsel ifadelerle toplama ve çıkarma işlemleri yapar.' },
              { id: 'M.7.2.1.2', text: 'Bir doğal sayı ile bir cebirsel ifadeyi çarpar.' },
              { id: 'M.7.2.1.3', text: 'Sayı örüntülerinin kuralını harfle ifade eder, kuralı harfle ifade edilen örüntünün istenilen terimini bulur.' },
            ],
          },
          {
            name: 'Eşitlik ve Denklem',
            kazanımlar: [
              { id: 'M.7.2.2.1', text: 'Eşitliğin korunumu ilkesini anlar.' },
              { id: 'M.7.2.2.2', text: 'Birinci dereceden bir bilinmeyenli denklemi tanır ve verilen gerçek hayat durumlarına uygun birinci dereceden bir bilinmeyenli denklem kurar.' },
              { id: 'M.7.2.2.3', text: 'Birinci dereceden bir bilinmeyenli denklemleri çözer.' },
              { id: 'M.7.2.2.4', text: 'Birinci dereceden bir bilinmeyenli denklem kurmayı gerektiren problemleri çözer.' },
            ],
          },
        ],
      },
        ...
        altKonular: [
          {
            ...
            kazanımlar: [
              { id: 'M.7.3.1.1', text: 'Bir açıyı iki eş açıya ayırarak açıortayı belirler.' },
              { id: 'M.7.3.1.2', text: 'İki paralel doğruyla bir keseninin oluşturduğu yöndeş, ters, iç ters, dış ters açıları belirleyerek özelliklerini inceler; oluşan açıların eş veya bütünler olanlarını belirler; ilgili problemleri çözer.' },
            ],
          },
          {
            name: 'Çokgenler',
            kazanımlar: [
              { id: 'M.7.3.2.1', text: 'Düzgün çokgenlerin kenar ve açı özelliklerini açıklar.' },
              { id: 'M.7.3.2.2', text: 'Çokgenlerin köşegenlerini, iç ve dış açılarını belirler; iç açılarının ve dış açılarının ölçüleri toplamını hesaplar.' },
              { id: 'M.7.3.2.3', text: 'Dikdörtgen, paralelkenar, yamuk ve eşkenar dörtgeni tanır; açı özelliklerini belirler.' },
              { id: 'M.7.3.2.4', text: 'Eşkenar dörtgen ve yamuğun alan bağıntılarını oluşturur, ilgili problemleri çözer.' },
              { id: 'M.7.3.2.5', text: 'Alan ile ilgili problemleri çözer.' },
            ],
          },
          {
            name: 'Çember ve Daire',
            kazanımlar: [
              { id: 'M.7.3.3.1', text: 'Çemberde merkez açıları, gördüğü yayları ve açı ölçüleri arasındaki ilişkileri belirler.' },
              { id: 'M.7.3.3.2', text: 'Çemberin ve çember parçasının uzunluğunu hesaplar.' },
              { id: 'M.7.3.3.3', text: 'Dairenin ve daire diliminin alanını hesaplar.' },
            ],
          },
          {
            name: 'Cisimlerin Farklı Yönlerden Görünümleri',
            kazanımlar: [
              { id: 'M.7.3.4.1', text: 'Üç boyutlu cisimlerin farklı yönlerden iki boyutlu görünümlerini çizer.' },
              { id: 'M.7.3.4.2', text: 'Farklı yönlerden görünümlerine ilişkin çizimleri verilen yapıları oluşturur.' },
            ],
          },
        ],
      },
        ...
        altKonular: [
          {
            name: 'Veri Analizi',
            kazanımlar: [
              { id: 'M.7.4.1.1', text: 'Verilere ilişkin çizgi grafiği oluşturur ve yorumlar.' },
              { id: 'M.7.4.1.2', text: 'Bir veri grubuna ait ortalama, ortanca ve tepe değeri bulur ve yorumlar.' },
              { id: 'M.7.4.1.3', text: 'Bir veri grubuna ilişkin daire grafiğini oluşturur ve yorumlar.' },
              { id: 'M.7.4.1.4', text: 'Verileri sütun, daire veya çizgi grafiği ile gösterir ve bu gösterimler arasında uygun olan dönüşümleri yapar.' },
            ],
          },
        ],
      },
...
export const mathCurriculum: Record<number, OgrenmeAlani[]> =
    flattenLegacyCurriculum(mathLegacyCurriculum);
